...
#ifndef REED_CONTROL_LEE_POSITION_CONTROLLER_H
#define REED_CONTROL_LEE_POSITION_CONTROLLER_H

#include <mav_msgs/conversions.h>
#include <mav_msgs/eigen_mav_msgs.h>

#include "reed_control/common.h"
#include "reed_control/parameters.h"
...
class QuatPositionControllerParameters {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  QuatPositionControllerParameters()
...
class QuatPositionController {
 public:
  QuatPositionController();
  ~QuatPositionController();
  ...
  QuatPositionControllerParameters controller_parameters_;
...
#endif // REED_CONTROL_LEE_POSITION_CONTROLLER_H
